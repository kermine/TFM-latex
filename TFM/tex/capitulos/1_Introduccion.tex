...
\item[Capítulo 3 Análisis de requisitos]: En este capítulo se describen los requisitos que debe de cumplir el modelo.

\item[Capítulo 4 Investigación y conceptos teóricos]: En este capítulo se describen los principales conceptos que han sido necesarios para llevar a cabo la realización de este proyecto y su entendimiento.

\item[Capítulo 5 Alternativas de diferentes IA´s]: En este capítulo se describe el estudio que se realizó de diferentes modelos de inteligencia artificial con el fin de que cumplieran con el propósito del proyecto y sus objetivos.

\item[Capítulo 6 Selección de modelo y proceso de implementación]: En este capítulo se describe la selección final del modelo escogido para reentrenarlo y su implementación.
...
\item[Capítulo 8 Evaluación del modelo y discusión]: En este capítulo se desglosa y expone el cuestionario rellenado por los expoertos que han probado el modelo y su valoración en los diferentes aspectos que debe de realizar.

\item[Capítulo 9 Tecnologías utilizadas]: En este capítulo se habla de las tecnologías software empleadas para la realización del proyecto.

\item[Capítulo 10 Conclusiones y líneas de trabajo futuras]: En este capítulo se habla de las conclusiones tras la realización del proyecto, las posibles mejoras a realizar y trabajos a futuro. 
