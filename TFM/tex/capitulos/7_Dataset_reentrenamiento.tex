\capitulo{7}{Dataset para reentrenar el modelo y frontal}
...
\begin{itemize}
    ...
    \item Problemas generados por el alumno: gracias a los dos anteriores podido generar mas ejemplos o que me ha permitido generar mas ejemplos para tener un dataset con 177 promts que tratan los diferentes conceptos de la asignatura.
\end{itemize}
