\chapter{Investigación y conceptos teóricos}
En este capítulo nos centraremos especialmente en conceptos teóricos importantes para entender el trabajo realizado.
...
Este apartado pretende recoger las diferentes formas de conseguir que el modelo seleccionado adapte su salida basándose en un conjunto de datos seleccionados por el usuario. En nuestro caso serán los programas Java de la asignatura y los documentos de buenas y malas prácticas. Existen diferentes formas de adaptar nuestro modelo entre las cuales podemos destacar:  RAG (Retrieval-Augmented Generation), LoRA/QLoRA (Low-Rank Adaptation/ Quantum  Low-Rank Adaptation) y el Ajuste fino completo (ajuste fino entrenando todos los parámetros del modelo). A continuación, para cada técnica se explica como  funciona, las herramientas típicas para implementarla, requisitos de hardware, ventajas, desventajas y escenarios recomendados de uso.
