\capitulo{5}{Alternativas de diferentes IA´s}
En este capitulo se centra principalmente en la investigación realizada para encontrar un modelo adecuado para la tarea del proyecto partiendo de un análisis inicial del problema hasta los posibles lenguajes candidatos. 
...
\begin{itemize}
	...
	\item Posee varieantes del modelo desde 8B a 70B de parámetros 
    \item Posee un modelo \textit{instruct} que esta adaptado tanto para recibir código como preguntas en lenguaje natural.
