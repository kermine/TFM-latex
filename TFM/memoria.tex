...
\newcommand{\imagen}[3][0.9\textwidth]{%
	\begin{figure}[!h]
		\centering
...
\noindent D. Carlos E. Vivaracho Pascual, profesor del departamento de nombre Ingeniería Informática de la Universidad de Valladolid.
...
\begin{abstract}
Este proyecto abarca la necesidad de la creación de un modelo de inteligencia artificial open source, el cual esté adaptado a las necesidades de la asignatura de Fundamentos de Programación impartida en el grado de Ingeniería informática de la universidad de Valladolid. La adaptación se realizará a través de un reentrenamiento con el código en Java y normas impartidas en la asignatura. 

El objetivo es un modelo de IA que este adaptado al contexto de la asignatura que están cursando, no como los modelos generales que normalmente suelen ser consultados, de esta manera obtendrán respuestas y resolverán las dudas adaptadas a los contenidos de la asignatura.
...
\include{./tex/capitulos/1_Introduccion}
\include{./tex/capitulos/2_Metodologia_y_Planificacion}
\include{./tex/capitulos/3_Investigacion_Conceptos_teoricos}
\include{./tex/capitulos/4_Comprension_del_negocio.tex}
\include{./tex/capitulos/5_Los_datos.tex}
\include{./tex/capitulos/6_Modelos}
\include{./tex/capitulos/7_Evaluacion}
\include{./tex/capitulos/8_Despliegue}
\include{./tex/capitulos/9_Prueba_Inicial}
\include{./tex/capitulos/10_Prueba_Modelo_Inicial}
\include{./tex/capitulos/11_Implementacion_Final}
\include{./tex/capitulos/12_Tecnologias_utilizadas}
\include{./tex/capitulos/13_Conclusiones_Lineas_de_trabajo_futuras}
...
\include{./tex/A_Documento_Malas_Praxis}
\include{./tex/B_Encuesta_Expertos}
\include{./tex/C_Manual_usuario}
